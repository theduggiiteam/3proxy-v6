var getid = async function(sec_user_id, max_cursor) {
    var res = await fetch("https://youtube.com/aweme/v1/web/aweme/post/?device_platform=webapp&aid=6383&channel=channel_pc_web&sec_user_id=" + sec_user_id + "&max_cursor=" + max_cursor, {
        "headers": {
        ...
        "referrer": "https://www.youtube.com/channel/UCVoqVPIpcdoC9U2iVtEVPGQ/videos",
...
var saveToFile = function(text) {
    ...
    a.download = 'youtube-video-links.txt';
    a.click();
}
